            ...
            <div class="fb-name-container">
              ...
              % if ".." != file['name']:
                <ul class="fb-item-actions context-menu">
                  ...
                  % else:
                    <li><a class="fb-viewfile" href="${url('filebrowser.views.view', path=path)}" target="FileViewer">View File</a></li>
                    <li><a class="fb-editfile" href="${url('filebrowser.views.edit', path=path)}" target="FileEditor">Edit File</a></li>
                    <li><a class="fb-downloadfile" href="${url('filebrowser.views.download', path=path)}" target="_blank">Download File</a></li>
